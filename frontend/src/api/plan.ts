...
export function listPlans(params: { page?: number; page_size?: number; community_id?: string; name?: string; cycle_type?: string; patrol_type?: string; plan_kind?: string; status?: number | '' }) {
