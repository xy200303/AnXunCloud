<!-- 审批流程（系统管理，租户级）：打卡审批流程 + 报告签字流程租户默认配置（扩展方案 §3）。
  ...
  <div class="app-container">
    <div class="table-card">
      <el-alert
        type="info"
        :closable="false"
        title="此处为公司级默认，对本公司全部小区生效；单个小区可在「小区管理 → 编制」中单独配置。打卡审批流程管打卡记录的逐级审批；报告签字流程管报告生成后的签字审核（保存空流程表示生成后直接归档）。"
...
import { getReviewFlow, saveReviewFlow, getReportReviewFlow, saveReportReviewFlow, listPostDutyBindings, type ReviewFlowStep, type PostDutyBindingView } from '@/api/post'
